...
set_property -dict {PACKAGE_PIN T9 IOSTANDARD LVCMOS25} [get_ports {led[6]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS25} [get_ports {led[7]}]
...
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS25} [get_ports {tmds_data_p[2]}]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS25} [get_ports {tmds_data_p[1]}]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS25} [get_ports {tmds_data_p[0]}]
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS25} [get_ports tmds_clk_p]

set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS25} [get_ports {tmds_data_n[2]}]
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS25} [get_ports {tmds_data_n[1]}]
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS25} [get_ports {tmds_data_n[0]}]
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS25} [get_ports tmds_clk_n]
