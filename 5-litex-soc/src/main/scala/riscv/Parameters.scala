...
object Parameters {
  ...
  // Program entry point for LiteX: integrated ROM at 0x00000000.
  // Classroom 4-soc images historically loaded at 0x1000; that offset is
  // wrong here. Given for this lab (see LiteXTopTest).
